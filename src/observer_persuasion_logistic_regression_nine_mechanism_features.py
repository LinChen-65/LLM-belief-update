...
DEFAULT_OUT_DIR = "/data7/chenyitong/Winning_Arguments/final_v3_Experiment_Analysis_Results/observer_nine_mechanism_feature_logistic_regression"

DEFAULT_AGENT_RESULT_PATHS = [
    "/data7/chenyitong/Winning_Arguments/final_v3_results_observer_deepseek-ai_DeepSeek-V3.json",
    "/data7/chenyitong/Winning_Arguments/final_v3_results_observer_google_gemini-2.5-flash-lite.json",
    "/data7/chenyitong/Winning_Arguments/final_v3_results_observer_gpt-4o-mini.json",
    "/data7/chenyitong/Winning_Arguments/final_v3_results_observer_Pro_MiniMaxAI_MiniMax-M2.5.json",
    "/data7/chenyitong/Winning_Arguments/final_v3_results_observer_Pro_zai-org_GLM-4.7.json",
    "/data7/chenyitong/Winning_Arguments/final_v3_results_observer_Qwen_Qwen2.5-32B-Instruct.json",
    "/data7/chenyitong/Winning_Arguments/final_v3_results_observer_Qwen_Qwen2.5-72B-Instruct.json",
]
...
def main():
    ...
    print(f"Observer regression rows: {len(agent_df)}")
    ...
    metadata = {
        ...
        "n_observer_regression_rows": int(len(agent_df)),
        ...
        "regression_note": "Observer-result version. Dependent variable is agent_delta_awarded parsed from observer files. Regressions use the nine mechanism features only. Pooled regression includes model fixed effects; per-model regressions are robustness checks.",
    }
    ...
    with open(out_dir / "quick_report.txt", "w", encoding="utf-8") as f:
        ...
        f.write(f"Observer regression rows: {len(agent_df)}\n")
