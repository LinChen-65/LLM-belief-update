...
DEFAULT_OUT_DIR = "/data7/chenyitong/Winning_Arguments/final_v3_Experiment_Analysis_Results/agent_text_feature_logistic_regression"
...
def main():
    ...
    metadata = {
        ...
        "regression_note": "Dependent variable is agent_delta_awarded. Pooled regression includes model fixed effects; per-model regressions are robustness checks.",
    }
