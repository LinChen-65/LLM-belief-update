...
DEFAULT_OUT_DIR = os.path.join(ROOT, "regression_output", "agent_nine")

DEFAULT_AGENT_RESULT_PATHS = [
    os.path.join(DATA, "first_person", "final_v3_results_deepseek-ai_DeepSeek-V3.json"),
    os.path.join(DATA, "first_person", "final_v3_results_google_gemini-2.5-flash-lite.json"),
    os.path.join(DATA, "first_person", "final_v3_results_gpt-4o-mini.json"),
    os.path.join(DATA, "first_person", "final_v3_results_Pro_MiniMaxAI_MiniMax-M2.5.json"),
    os.path.join(DATA, "first_person", "final_v3_results_Pro_zai-org_GLM-4.7.json"),
    os.path.join(DATA, "first_person", "final_v3_results_Qwen_Qwen2.5-32B-Instruct.json"),
    os.path.join(DATA, "first_person", "final_v3_results_Qwen_Qwen2.5-72B-Instruct.json"),
    os.path.join(DATA, "first_person", "final_v3_results_gpt-5.5.json"),
]
